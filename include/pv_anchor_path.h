...
void pv_anchor_path_add_anchor_point(PvAnchorPath *, PvAnchorPoint);
int pv_anchor_path_insert_anchor_point(PvAnchorPath *, PvAnchorPoint, int index);
...
bool pv_anchor_path_set_anchor_point_from_index(PvAnchorPath *, int index, PvAnchorPoint ap);
